...
# Updated: 5/14/2020
# Project: COVID19
# Script: delta ECv calculation

import pandas as pd
import matplotlib.pyplot as plt

def main():
    filename = '../ECv_result/processing/network_th005/ECv_network_result_300k_0.05_processing.txt'
    ...
    # Series15
    ecv['deltaECv_Series15'] = abs((ecv['Series15_HealthyLungBiopsy_1']
                                  + ecv['Series15_HealthyLungBiopsy_2'])/2
                                 - (ecv['Series15_COVID19Lung_1']
                                  + ecv['Series15_COVID19Lung_2'])/2)
    # Series16
    ...
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series1.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series2.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series3.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series4.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series5.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series6.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series7.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series8_1.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series8_2.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series9_1.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series9_2.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series9_3.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series9_4.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series9_5.png', dpi=300, format='png')
    plt.clf()

    delta_Series15 = ecv.loc[:,['Parent', 'Child', 'deltaECv_Series15']]
    plt.hist(delta_Series15['deltaECv_Series15'], log=True, color='plum', alpha=0.6, edgecolor='k', lw=0.8, bins=40)
    plt.title('ΔECv histogram')
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series15.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series16_1.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/processing/network_th005/deltaECv_histogram_Series16_2.png', dpi=300, format='png')
    plt.clf()
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series1_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series2_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series3_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series4_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series5_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series6_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series7_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series8_1_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series8_2_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series9_1_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series9_2_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series9_3_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series9_4_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series9_5_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series15_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series16_1_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/processing/network_th005/deltaECv_table_Series16_2_th1.txt', 'w') as f:
