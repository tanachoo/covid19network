...
def main():
    filename = '../ECv_result/vitroRNAseq/network_th005/ECv_network_result_500k_0.05_processing.txt'
    ...
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series1.png', dpi=300, format='png')
    plt.clf()
    '''
    ...
    plt.hist(delta_Series2['deltaECv_Series2'], log=True, color='blue', alpha=0.6, edgecolor='k', lw=0.8, bins=40)
    #plt.title('ΔECv histogram', fontsize=24)
    plt.xlabel('ΔECv', fontsize=24)
    plt.ylabel('frequency', fontsize=24)
    plt.tick_params(labelsize=20)
    plt.tight_layout()
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series2_blue.png', dpi=300, format='png')
    plt.close()
    '''
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series3.png', dpi=300, format='png')
    plt.clf()
    '''
    ...
    plt.hist(delta_Series4['deltaECv_Series4'], log=True, color='yellow', alpha=0.6, edgecolor='k', lw=0.8, bins=40)
    #plt.title('ΔECv histogram')
    plt.xlabel('ΔECv', fontsize=24)
    plt.ylabel('frequency', fontsize=24)
    plt.tick_params(labelsize=20)
    plt.tight_layout()
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series4_yellow.png', dpi=300, format='png')
    plt.close()
    ...
    plt.hist(delta_Series5['deltaECv_Series5'], log=True, color='magenta', alpha=0.6, edgecolor='k', lw=0.8, bins=40)
    #plt.title('ΔECv histogram')
    plt.xlabel('ΔECv', fontsize=24)
    plt.ylabel('frequency', fontsize=24)
    plt.tick_params(labelsize=20)
    plt.tight_layout()
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series5_magenta.png', dpi=300, format='png')
    plt.close()
    '''
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series6.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series7.png', dpi=300, format='png')
    plt.clf()
    '''
    ...
    plt.hist(delta_Series8_1['deltaECv_Series8_1'], log=True, color='lime', alpha=0.6, edgecolor='k', lw=0.8, bins=40)
    #plt.title('ΔECv histogram')
    plt.xlabel('ΔECv', fontsize=24)
    plt.ylabel('frequency', fontsize=24)
    plt.tick_params(labelsize=20)
    plt.tight_layout()
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series8_1_green.png', dpi=300, format='png')
    plt.close()
    ...
    plt.hist(delta_Series8_2['deltaECv_Series8_2'], log=True, color='slateblue', alpha=0.6, edgecolor='k', lw=0.8, bins=40)
    #plt.title('ΔECv histogram')
    plt.xlabel('ΔECv', fontsize=24)
    plt.ylabel('frequency', fontsize=24)
    plt.tick_params(labelsize=20)
    plt.tight_layout()
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series8_2_slateblue.png', dpi=300, format='png')
    plt.close()
    '''
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series9_1.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series9_2.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series9_3.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series9_4.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series9_5.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series16_1.png', dpi=300, format='png')
    plt.clf()
    ...
    plt.xlabel('ΔECv')
    plt.ylabel('frequency')
    plt.savefig('../ECv_result/vitroRNAseq/network_th005/deltaECv_histogram_Series16_2.png', dpi=300, format='png')
    plt.clf()
    '''
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series1_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series2_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series3_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series4_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series5_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series6_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series7_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series8_1_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series8_2_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series9_1_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series9_2_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series9_3_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series9_4_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series9_5_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series16_1_th1.txt', 'w') as f:
    ...
    with open('../ECv_result/vitroRNAseq/network_th005/deltaECv_table_Series16_2_th1.txt', 'w') as f:
